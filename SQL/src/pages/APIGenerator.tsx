...
// import { getDatabaseDetail, generateAPI, publishAPI } from '../utils/api';
...
//       }
//       try {
//         const data = await getDatabaseDetail(db_id);
//         setConnectionDetails(data);
//         setConnectionError(null);
//       } catch (error) {
//         setConnectionError('Failed to fetch database connection details');
//       }
//     };
...
//                               className="w-full p-3 text-sm bg-white/10 border border-white/20 text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/50 backdrop-blur-sm"
//                             >
...
//                                     <span className="text-xs text-gray-900 bg-white/10 px-2 py-1 rounded">{param.type}</span>
//                                     {param.required && (
//                                       <span className="text-xs bg-red-500/20 border border-red-500/30 text-red-300 px-2 py-1 rounded">required</span>
//                                     )}
//                                   </div>
//                                   <p className="text-xs text-gray-900 mb-2">{param.description}</p>
//                                   {param.example && (
//                                     <code className="text-xs text-gray-900 bg-white/5 px-2 py-1 rounded">Example: {param.example}</code>
//                                   )}
//                                 </div>
//                               ))}
//                             </div>
